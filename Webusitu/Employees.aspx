...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button CssClass="btn btn-info" ID="addEmployeeBtn" runat="server" OnClick="addEmployeeBtn_Click" Text="Add" />
    <br />
    <br />
    ...
    <asp:Label ID="enteremplbl" runat="server" Font-Bold="True" Font-Size="20pt" Text="Enter Employees Below "></asp:Label>
        ...
        <br />
        ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox CssClass="form-control" ID="IDtxt" runat="server"></asp:TextBox>
        ...
        <br />
        First Name :&nbsp; <asp:TextBox CssClass="form-control" ID="firstnametxt" runat="server"></asp:TextBox>
        ...
        <br />
        <br />
        Last Name :&nbsp; <asp:TextBox CssClass="form-control" ID="lastnametxt" runat="server" Height="35px"></asp:TextBox>
        ...
        <br />
        Telephone:&nbsp;&nbsp;
        <asp:TextBox CssClass="form-control" ID="telephonetxt" runat="server"></asp:TextBox>&nbsp;
        <%--- <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator10" ControlToValidate="emailtxt" Display="Dynamic" ErrorMessage="*" />--%>

        <br />
        <br />
        Department:&nbsp;
        <asp:DropDownList CssClass="form-control" ID="departmentDD" runat="server" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="Name">
        </asp:DropDownList>
        ...
        <br />
        <asp:Button CssClass="btn btn-info" ID="Button1" runat="server" OnClick="Button1_Click" Text="Submit" />
        <br />
